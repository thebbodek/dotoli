...
export const NOTIFICATION_CARD_META_STYLE = 'flex-h-stack-center gap-[5px]';

export const NOTIFICATION_CARD_META_DIVIDER_STYLE =
...
export const NOTIFICATION_CARD_COLORS: NotificationCardColors = {
  ...
  META_TEXT: COLOR_VARIANTS.GRAY_500,
  META_EXTRA_TEXT: COLOR_VARIANTS.GRAY_700,
