...
const FilterCalendarPanel = ({ variant }: FilterCalendarPanelProps) => {
  ...
  return (
    ...
    >
      <Flex
        direction='column'
        className='in-tablet:min-h-[34svh-3.75rem] in-tablet:max-h-[46svh-3.75rem] in-tablet:min-w-[23.75rem] mx-auto h-[100svh-4rem] w-[22.5rem] justify-between overflow-hidden'
      >
        <Calendar
