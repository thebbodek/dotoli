...
export const getPopoverPosition = ({
  ...
  const overflowRect = (root ?? document.body).getBoundingClientRect();
  ...
  const HORIZONTAL_METRICS = {
    OVERFLOW_LEFT_EDGE: overflowLeft + threshold,
    OVERFLOW_RIGHT_EDGE: overflowRight - threshold,
    POPOVER_LEFT_EDGE: triggerRight - popoverWidth,
    POPOVER_RIGHT_EDGE: triggerLeft + popoverWidth,
  } as const;
