...
export const RADIO_ICON_SIZE_STYLES_MAPPER: Record<RadioSize, string> = {
  [RADIO_SIZES.SM]:
...
export const RADIO_STYLES_MAPPER = {
  [RADIO_STATE.DEFAULT]: {
    icon: 'before:bg-white border-gray-02 bg-white',
    label: 'text-black',
  },
  [RADIO_STATE.SELECTED]: {
    icon: 'group-has-checked:before:bg-primary-06 group-has-checked:border-primary-06',
    label: 'group-has-checked:text-black',
  },
  [RADIO_STATE.DISABLED]: {
    icon: 'group-has-disabled:before:bg-gray-02 group-has-disabled:border-gray-02',
