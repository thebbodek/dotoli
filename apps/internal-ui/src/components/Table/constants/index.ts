...
export const TABLE_CELL_INPUT_STYLES = {
  ...
  [TABLE_CELL_INPUT_STATE.DISABLED]:
    'disabled:text-in-gray-05 disabled:border-in-gray-01 disabled:bg-in-gray-01 group-hover:disabled:bg-in-gray-02 group-hover:disabled:border-in-gray-02 disabled:cursor-not-allowed disabled:placeholder-in-gray-05',
} as const;
