...
const FlexItem = ({ children }: PropsWithChildren) => {
  return (
    <div className='text-label rounded-md bg-blue-100 px-2 py-1 text-blue-700'>
      {children}
    </div>
  );
};
  ...
  render: (args) => {
    ...
    return (
      <Flex
        ...
        align={align}
        justify={justify}
        wrap={originalProps.wrap || FLEX_WRAPS.WRAP}
      >
        {items}
      </Flex>
    );
