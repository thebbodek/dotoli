  ...
  argTypes: {
    direction: {
      ...
      table: {
        ...
        type: {
          summary: `'${Object.values(FLEX_DIRECTIONS).join("' | '")}'`,
        },
      },
    },
    alignContent: {
      table: {
        category: 'align',
        type: {
          summary: `'${Object.keys(FLEX_ALIGN_CONTENT_STYLES).join("' | '")}'`,
        },
      },
      name: 'content',
      control: 'select',
    ...
    alignItems: {
      table: {
        category: 'align',
        type: {
          summary: `'${Object.keys(FLEX_ALIGN_ITEM_STYLES).join("' | '")}'`,
        },
      },
      name: 'items',
      control: 'select',
    ...
    alignSelf: {
      table: {
        category: 'align',
        type: {
          summary: `'${Object.keys(FLEX_ALIGN_SELF_STYLES).join("' | '")}'`,
        },
      },
      name: 'self',
      control: 'select',
    ...
    justifyContent: {
      table: {
        category: 'justify',
        type: {
          summary: `'${Object.keys(FLEX_JUSTIFY_CONTENT_STYLES).join("' | '")}'`,
        },
      },
      name: 'content',
      control: 'select',
    ...
    justifyItems: {
      table: {
        category: 'justify',
        type: {
          summary: `'${Object.keys(FLEX_JUSTIFY_ITEM_STYLES).join("' | '")}'`,
        },
      },
      name: 'items',
      control: 'select',
    ...
    justifySelf: {
      table: {
        category: 'justify',
        type: {
          summary: `'${Object.keys(FLEX_JUSTIFY_SELF_STYLES).join("' | '")}'`,
        },
      },
      name: 'self',
      control: 'select',
    ...
    gap: {
      table: {
        category: 'gap',
        type: {
          summary: Object.values(FLEX_GAPS).join(' | '),
        },
      },
      name: 'gap',
      control: 'select',
    ...
    wrap: {
      ...
      table: {
        type: {
          summary: `'${Object.values(FLEX_WRAPS).join("' | '")}'`,
        },
      },
    },
    basis: {
      ...
      table: {
        type: {
          summary: Object.values(FLEX_BASES).join(' | '),
        },
      },
    },
    shrink: {
      ...
      table: {
        type: {
          summary: Object.values(FLEX_SHRINKS).join(' | '),
        },
      },
    },
    grow: {
      ...
      table: {
        type: {
          summary: Object.values(FLEX_GROWS).join(' | '),
        },
      },
    },
    flex: {
      ...
      table: {
        type: {
          summary: Object.values(FLEX_GROW_AND_SHRINK_AND_BASIS).join(' | '),
        },
      },
    },
    order: {
      ...
      table: {
        type: {
          summary: Object.values(FLEX_ORDERS).join(' | '),
        },
      },
    },
  },
